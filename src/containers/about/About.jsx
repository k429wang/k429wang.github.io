    ...
    <div className="about-container">
      ...
      <div className="about-right">
        ...
        <ul className="about-points">
          ...
          <li> 🎮 When not working, I like to play video games, volleyball, and rock climbing </li>
          <li> 🎯 <strong>Seeking full-time Software Engineering roles starting Summer 2026</strong></li>
        </ul>
      </div>
    </div>
  </div>;
