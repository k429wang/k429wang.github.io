...
export default function Contact() {
  return <div className='contact' name="contact">
      ...
      <div className='links'>
        <a className="link" href="https://www.linkedin.com/in/k429wang/" target="_blank" rel="noreferrer">             
        ...
        <a className="link" href="mailto:k429wang@uwaterloo.ca" target="_blank" rel="noreferrer">
        ...
        <a className="link" href="https://github.com/k429wang" target="_blank" rel="noreferrer">             
